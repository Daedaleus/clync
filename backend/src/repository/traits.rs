...
pub trait UserRepo: Send + Sync {
    ...
    async fn update_social_profile(&self, keycloak_id: String, steam_handle: Option<String>, steam_visibility: Visibility, discord_handle: Option<String>, discord_visibility: Visibility) -> Result<(), surrealdb::Error>;
...
pub trait GameRepo: Send + Sync {
    ...
    async fn upsert_with_details(&self, name: String, description: Option<String>, genre: Option<String>) -> Result<(), surrealdb::Error>;
...
pub trait SessionRepo: Send + Sync {
    async fn create(
        &self, user_id: String, username: String, game: String,
...
pub trait InviteRepo: Send + Sync {
    async fn create(&self, code: String, created_by: String, expires_at: String) -> Result<(), surrealdb::Error>;
...
pub trait InvitationRepo: Send + Sync {
    async fn create(&self, group_id: String, group_name: String, inviter_id: String, inviter_username: String, invitee_id: String) -> Result<(), surrealdb::Error>;
